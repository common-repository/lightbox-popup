...
class wpdevart_lightbox_database_params{
	...
	public $installed_options; // All standard options for the Lightbox Popup
	...
	function __construct(){
		...
		$this->installed_options=array(
			...
			"overlay_parametrs"=>array(
				"overlay_transparency_prancent"				=> "75",
			),
			"popup_parametrs"=>array(
				"enable_video_popuping"						=> "enable",
			...
			"information_panel"=>array(
				...
				"information_panel_padding_top"		        => "0",
				"information_panel_padding_bottom"		        => "0",				
				...
				"information_panel_desc_padding_right"		=> "5",
